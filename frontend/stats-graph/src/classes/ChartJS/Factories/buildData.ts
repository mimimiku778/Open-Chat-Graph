  ...
  if (ocChart.getMode() === 'candlestick') {
    ...
    if (ocChart.ohlcRankingData.length) {
      datasets.push({
        ...
        color: { up: 'rgba(41, 121, 255, 0.3)', down: 'rgba(255, 109, 0, 0.3)', unchanged: 'rgba(158, 158, 158, 0.3)' },
        backgroundColors: { up: 'rgba(41, 121, 255, 0.08)', down: 'rgba(255, 109, 0, 0.08)', unchanged: 'rgba(158, 158, 158, 0.08)' },
        borderColors: { up: 'rgba(41, 121, 255, 0.3)', down: 'rgba(255, 109, 0, 0.3)', unchanged: 'rgba(158, 158, 158, 0.3)' },
        borderWidth: 1,
        datalabels: { display: false },
        animation: false as const,
