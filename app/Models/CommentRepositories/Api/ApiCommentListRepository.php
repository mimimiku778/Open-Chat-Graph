...
/**
 * Repository for comment list from ocgraph_sqlapi SQLite database
 * Provides read-only access to archived comment data
 */
class ApiCommentListRepository implements CommentListRepositoryInterface
{
    function findComments(CommentListApiArgs $args): array
    {
        ...
        return SQLiteOcgraphSqlapi::fetchAll($query, [
    ...
    function findCommentById(int $comment_id): array|false
    {
        ...
        return SQLiteOcgraphSqlapi::fetch($query, compact('comment_id'));
    }
    ...
    function getCommentIdArrayByOpenChatId(int $open_chat_id): array
    {
        ...
        return SQLiteOcgraphSqlapi::fetchAll($query, compact('open_chat_id'), [\PDO::FETCH_COLUMN, 0]);
    }
