-- Schema for database: ocgraph_rankingth
-- Extracted from: ocgraph_rankingth.sql
-- Generated: Mon Jan 12 01:35:58 JST 2026

CREATE DATABASE IF NOT EXISTS `ocgraph_rankingth` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `ocgraph_rankingth`;
