-- Schema for database: ocgraph_rankingtw
-- Extracted from: ocgraph_rankingtw.sql
-- Generated: Mon Jan 12 01:36:00 JST 2026

CREATE DATABASE IF NOT EXISTS `ocgraph_rankingtw` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `ocgraph_rankingtw`;
